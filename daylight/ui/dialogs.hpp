...
class ProcessItems {
	...
	class controls {
		...
		class RscShortcutButton_1700: RscShortcutButton {
			...
			action = "closeDialog 0; [daylight_iProcessUnitIndexCurrent, (lbCurSel 1500)] spawn daylight_fnc_processProcessItems";
		};
...
class AdminMenu {
	...
	class controls {
		...
		class RscShortcutButton_1703: RscShortcutButton {
			...
			action = "call daylight_fnc_adminMenuTeleportToPlayer";
		};
